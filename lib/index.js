...
function createHtml(opts) {
    ...
    fs_1.writeFileSync(opts.paths.htmlFile, html_1["default"](opts));
}
...
function typescriptCompileJs(opts) {
    ...
    try {
        child_process_1.execSync(__dirname + "/../../../node_modules/.bin/tsc --project " + tsConfigFile);
    }
    catch (err) {
...
function typescriptWatchJs(opts) {
    ...
    var tsConfigFile = path.join(opts.paths.src, 'js', 'tsconfig.json');
    var jsTsc = child_process_1.spawn(__dirname + "/../../../node_modules/.bin/tsc", ['--watch', '--project', tsConfigFile], {
        env: process.env,
        stdio: 'inherit'
    });
...
function typescriptWatchJsx(opts) {
    ...
    var tsConfigFile = path.join(opts.paths.src, 'jsx', 'tsconfig.json');
    var jsxTsc = child_process_1.spawn(__dirname + "/../../../node_modules/.bin/tsc", ['--watch', '--project', tsConfigFile], {
        env: process.env,
        stdio: 'inherit'
    });
    process.on('exit', function () {
