...
function copyDeps(opts, pkg) {
    return __awaiter(this, void 0, void 0, function () {
        var packageJson, deps, _i, _a, dep, err_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    err_2 = _b.sent();
                    console.error('Error while copying', err_2);
                    return [3, 5];
...
function browserifyBundleCep(opts, src) {
    ...
    var transform = [
        ...
        require('envify'),
        require('brfs')
    ].concat((opts.browserify && opts.browserify[src] && opts.browserify[src].transform ? opts.browserify[src].transform : []));
    var plugin = (opts.browserify && opts.browserify[src] && opts.browserify[src].plugin ? opts.browserify[src].plugin : []);
...
function browserifyBundleExtendScript(opts, src) {
    ...
    return new Promise(function (resolve) {
        ...
        ].concat((opts.browserify && opts.browserify[src] && opts.browserify[src].plugin ? opts.browserify[src].plugin : []));
        var bundler = browserify({
            entries: [entryFile],
            cache: {},
            packageCache: {},
...
function browserifyWatchCep(opts, src, i) {
    ...
    var plugin = (opts.live ? [[require('livereactload'), { host: opts.livereactloadHost || 'localhost' }]] : []).concat((opts.browserify && opts.browserify[src] && opts.browserify[src].plugin) ? opts.browserify[src].plugin : []);
    budo(entryFile, {
        browserify: {
            debug: true,
            extensions: ['.js', '.jsx'],
